...
class 저장소 {
    static void 저장(byte b) {
    }
    static void 저장(char c) {
    }
    static void 저장(short s) {
    }
    static void 저장(int i) {
    }
    static void 저장(long l) {
    }
    static void 저장(float f) {
    }
    static void 저장(double d) {
    }
    static void 저장(boolean bl) {
    }
    static void 저장(String str) {
    }
    static void 저장(사람 a사람) {
    }
    static void 저장(사과 a사과) {
    }
}
